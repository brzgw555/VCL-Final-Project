...
namespace VCX::Labs::Rendering {
    SkyboxObject::SkyboxObject(Engine::Skybox const & skybox):
        ...
        CubeMap(skybox.Images, { .WrapU = Engine::GL::WrapMode::Clamp, .WrapV = Engine::GL::WrapMode::Clamp, .WrapW = Engine::GL::WrapMode::Clamp, .MinFilter = Engine::GL::FilterMode::Linear, .MagFilter = Engine::GL::FilterMode::Linear }) {
    ...
    static Engine::GL::UniqueTexture2D MakeTexture(Engine::Texture2D<Format> const & val, std::uint32_t const texUnit) {
        return Engine::GL::UniqueTexture2D(
            val, { .WrapU = Engine::GL::WrapMode::Repeat, .WrapV = Engine::GL::WrapMode::Repeat, .MinFilter = Engine::GL::FilterMode::Trilinear, .MagFilter = Engine::GL::FilterMode::Trilinear }, texUnit);
    }
    ...
    static Engine::GL::UniqueIndexedRenderItem MakeRenderItem(Engine::SurfaceMesh const & mesh) {
        Engine::GL::UniqueIndexedRenderItem item(Engine::GL::VertexLayout().Add<glm::vec3>("position", Engine::GL::DrawFrequency::Static, 0).Add<glm::vec3>("normal", Engine::GL::DrawFrequency::Static, 1).Add<glm::vec2>("texcoord", Engine::GL::DrawFrequency::Static, 2), Engine::GL::PrimitiveType::Triangles);
